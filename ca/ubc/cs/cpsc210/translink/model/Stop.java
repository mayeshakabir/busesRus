...
public class Stop implements Iterable<Arrival> {
    ...
    private LatLon locn; //* location of this stop
    private int number; //number of this stop
    ...
    public void addRoute(Route route) {
        routes.add(route); //add route to set of routes
        route.addStop(this); //set of routes with stops
    }
